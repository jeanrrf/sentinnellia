...
import { Brain, Database, Terminal, Zap } from 'lucide-react';
        ...
        <div className="z-10 relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <Link
                to="/mentoria"
                className="px-8 py-4 bg-transparent border border-neon-500/50 text-neon-400 font-mono text-sm tracking-widest uppercase rounded-sm hover:bg-neon-500/10 transition-all flex items-center justify-center gap-2 group"
              >
